...
$M_{\text{eff}}$. Later sections collect mechanism diagnostics and additional
...
\begin{table}[!htbp]
  ...
  \begin{tabularx}{\linewidth}{p{0.27\linewidth}p{0.27\linewidth}Y}
    ...
    Item-difficulty residualisation (cross-fitted + holdout), $M_{\text{eff}}$, random-effects representation, ViT cross-pretraining, cross-checkpoint same-family. \\
